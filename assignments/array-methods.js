...
let ticketPriceTotal = runners.reduce(function(element, runners) {
    return element + runners.donation;
},0)
...
// Problem 2
let smallShirts = runners.filter((element) => {
...
let allLower = [];
runners.map(function(element) {
    allLower.push(element.first_name.toLowerCase());
});
